...
function formatRoleLabel(role: string | null | undefined, isApplicant: boolean): string {
  if (isApplicant || !role) return 'Applicant'
...
export function UserMenu() {
  ...
  const roleLabel = formatRoleLabel(user.role, isApplicant)
