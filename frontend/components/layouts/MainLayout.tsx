        ...
        <div className="page-width grid grid-cols-2 md:grid-cols-5 gap-4 sm:gap-6 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs sm:text-sm">
              ...
              <li><Link href="/products?newArrival=true&sort=newest" className="hover:text-white">New Arrivals</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs sm:text-sm">
              {showGuestLinks && (
                <li><Link href="/auth/apply-vendor" className="hover:text-white">Apply to Sell</Link></li>
              )}
              {showAuthLinks && isVendor && (
                <li><Link href="/vendor" className="hover:text-white">Seller Dashboard</Link></li>
              )}
          ...
          <div>
            <h4 className="text-white font-medium mb-3 text-sm sm:text-base">Contact</h4>
            <ul className="space-y-2 text-xs sm:text-sm mb-4">
              <li>
                <a href="mailto:hello@lumiafrica.com" className="hover:text-white transition-colors">
                  hello@lumiafrica.com
                </a>
              </li>
              <li>
                <a href="tel:+254000000000" className="hover:text-white transition-colors">
                  +254 000 000 000
                </a>
              </li>
