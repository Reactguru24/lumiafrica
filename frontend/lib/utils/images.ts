...
/** Full-width strip shown below the homepage feature icons. */
export const HOMEPAGE_PROMO_BANNER =
  'https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=1920&h=600&fit=crop&q=80'

/** Four-image collage in the “Fashion From Nairobi to Kampala” section. */
export const HOMEPAGE_GRID_IMAGES = [
  {
    src: 'https://images.unsplash.com/photo-1617137968427-85924c800a22?w=800&h=1000&fit=crop&q=80',
    alt: 'Tailored menswear',
  },
  {
    src: 'https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?w=800&h=1000&fit=crop&q=80',
    alt: "Women's evening dress",
  },
  {
    src: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=800&h=1000&fit=crop&q=80',
    alt: 'Casual streetwear',
  },
  {
    src: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=800&h=1000&fit=crop&q=80',
