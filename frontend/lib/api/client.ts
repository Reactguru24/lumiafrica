...
export const adminAPI = {
  ...
  listShippingLanes() {
    return get('/admin/shipping-lanes')
  },

  createShippingLane(data: Record<string, unknown>) {
    return post('/admin/shipping-lanes', data)
  },

  updateShippingLane(laneId: string, data: Record<string, unknown>) {
    return put(`/admin/shipping-lanes/${laneId}`, data)
  },

  deleteShippingLane(laneId: string) {
    return del(`/admin/shipping-lanes/${laneId}`)
  },
